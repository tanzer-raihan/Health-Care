...
const Footer = () => {
    return (
        <div className='mt-5 footer pt-3'>
            <div >
               <h2><i class="fas fa-clinic-medical font"></i> MediTech</h2>
            ...
            <div className='d-flex justify-content-center align-items-center p-3 icon'>
                <h2 className='ms-5'><i class="fab fa-facebook-square"></i></h2>
                <h2 className='ms-5'><i class="fab fa-instagram-square"></i></h2>
                <h2 className='ms-5'><i class="fab fa-twitter-square"></i></h2>
                <h2 className='ms-5'><i class="fab fa-linkedin"></i></h2>
            </div>
        </div>
    );
};
